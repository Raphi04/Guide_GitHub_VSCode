...
![Page d'accueil d'un projet GitHub](../assets/getProject/code_button.png)

- Ensuite cliquer sur **_Download Zip_**

![Download Zip](../assets/getProject/download_zip.png)

## Via un clone du dépot GitHub (VS Code)

- La première étape est de cliqué sur **_la barre de commande de VS Code_**

![Barre de VS Code](../assets/getProject/barre_VSCode.png)

- Ensuite il faudra écrire `>clone` et sélectionner **_Git : Clone_**

![Barre de VS Code](../assets/getProject/git_Clone.png)

- Puis, cloner à partir de GitHub

![From Github](../assets/getProject/from_gitHub.png)
